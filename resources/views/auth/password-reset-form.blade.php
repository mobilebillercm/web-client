                                    ...
                                    <div class="">
                                        <div class="" style="color: #3db4e1; border-radius: 8px;">
                                            <div class="" style="width: 100%; padding: 15px; border-radius: 8px;">
                                                <form class="form-style-9 validate-form" method="post" action="{{url('users/'.$userid.'/password-reset/'.$resetinvitationid)}}">
                                                    <span class="login100-form-logo">
                                                        <i class="fa fa-sign-in"></i>
                                                    </span>

                                                    <span class="login100-form-title p-b-34 p-t-27">
                                                       <h4>Reconfigurer votre mot de passe</h4>
                                                    </span>
                                                    ...
                                                    <div class="form-group" style="text-align: left;">
                                                        <label for="newpassword" style="font-size: 16px;">Mot de Passe <b style="color: red;" class=""> *</b></label>
                                                    ...
                                                    <div class="form-group" style="text-align: left;">
                                                        <label for="passwordconfirmation" style="font-size: 16px;">Confirmer le Mot de Passe <b style="color: red;" class=""> *</b></label>
                                                        <input type="password" class="form-control form-control-text" required
                                                   ...
                                                   {{-- <div class="wrap-input100 validate-input" data-validate = "Enter a Valid E-mail">
                                                        <input class="input100" type="text" name="email" placeholder="" style="font-family: Poppins-Medium;" required>
                                                        <span class="focus-input100" data-placeholder="E-Mail"></span>
                                                    </div>
                                                    <div class="wrap-input100 validate-input" data-validate = "Password">
                                                        <input class="input100" type="password" name="newpassword" placeholder="" style="font-family: Poppins-Medium;" required>
                                                        <span class="focus-input100" data-placeholder="Password"></span>
                                                    </div>
                                                    <div class="wrap-input100 validate-input" data-validate = "Password Confirmation">
                                                        <input class="input100" type="password" name="passwordconfirmation" placeholder="" style="font-family: Poppins-Medium;" required>
