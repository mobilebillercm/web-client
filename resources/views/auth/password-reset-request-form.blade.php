                                    ...
                                    <div class="">
                                        <div class="" style="color: #3db4e1; border-radius: 8px;">
                                            <div class="" style="width: 100%; padding: 15px; border-radius: 8px;">
                                                <form class="form-style-9 validate-form" method="post" action="{{url('id/reset-password')}}">
                                                    <span class="login100-form-logo">
                                                        <i class="fa fa-sign-in"></i>
                                                    </span>

                                                    <span class="login100-form-title p-b-34 p-t-27">
                                                        <h4>demader a reconfigurer votre mot de passe</h4>
                                                    </span>
                                                   ...
                                                   {{-- <div class="wrap-input100 validate-input" data-validate = "Enter a Valid E-mail">
                                                        <input class="input100" type="text" name="email" placeholder="" style="font-family: Poppins-Medium;" onblur="filterPossibleTenant(this.value);" required>
                                                    ...
                                                    {{--<div class="wrap-input100 validate-input">
                                                        <select id="tenantid" name="tenantid" class="input100" required>
                                                        </select>
