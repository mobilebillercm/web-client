...
nohup php ~/Documents/app-code/business/mobile-biller-php/wallet/artisan serve --port 8047 --host 0.0.0.0  >/dev/null 2>&1 &
...
nohup php ~/Documents/app-code/business/mobile-biller-php/web-client/app/Infrastructure/Messaging/receipt-registered-queue-listener.php >/dev/null 2>&1 &
nohup php ~/Documents/app-code/business/mobile-biller-php/web-client/app/Infrastructure/Messaging/service-access-registered-queue-listener.php >/dev/null 2>&1 &
...
#nohup php ~/Documents/app-code/business/mobile-biller-php/web-client/app/Infrastructure/Messaging/payement-with-mobile-biller-credit-account-made-queue-listener.php >/dev/null 2>&1 &
nohup php ~/Documents/app-code/business/mobile-biller-php/web-client/app/Infrastructure/Messaging/user-password-changed-queue-listener.php >/dev/null 2>&1 &
...
nohup php artisan queue:work --tries=3 --timeout=500 >/dev/null 2>&1 &
nohup php ~/Documents/app-code/business/mobile-biller-php/payments/app/Infrastructure/Messaging/payement-with-mobile-biller-account-accepted-queue-listener.php  >/dev/null 2>&1 &
nohup php ~/Documents/app-code/business/mobile-biller-php/payments/app/Infrastructure/Messaging/payement-with-mobile-biller-account-failed-queue-listener.php  >/dev/null 2>&1 &
echo "PAYMENTS DONE ..."
...
cd ~/Documents/app-code/business/mobile-biller-php/receipts
nohup php artisan queue:work --tries=3 --timeout=500 >/dev/null 2>&1 &
...
nohup php ~/Documents/app-code/business/mobile-biller-php/service-access/app/Infrastructure/Messaging/service-payment-with-mobile-biller-credit-account-accepted-queue-listener.php  >/dev/null 2>&1 &
...
nohup php ~/Documents/app-code/business/mobile-biller-php/wallet/app/Infrastructure/Messaging/service-payement-with-mobile-biller-account-initiated-queue-listener.php >/dev/null 2>&1 &
echo "WALLET DONE ..."
