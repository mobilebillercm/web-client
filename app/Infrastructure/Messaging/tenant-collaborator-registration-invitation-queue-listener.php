...
use PhpAmqpLib\Connection\AMQPStreamConnection;
    ...
    $channel->exchange_declare(
        parse_ini_file("global-var-config.ini", true)['EXCHANGES']['TENANT_COLLABORATOR_INVITED_EXCHANGE'],
        'fanout',
        false,
        true,
        false);
    ...
    list($queue_name, ,) = $channel->queue_declare(
        parse_ini_file("global-var-config.ini", true)['QUEUES']['WEB_CLIENT_TENANT_COLLABORATOR_INVITED_QUEUE'],
        false,
        true,
        false,
        false);
    ...
    echo " [*] Waiting for tenant collaborator invitation to exit press CTRL+C\n";
    ...
    try {
        ...
        $url = parse_ini_file("global-var-config.ini", true)['URLS']['HOST_WEB_CLIENT'] . '/api/tenant-collaborators-invitations';
