...
use PhpAmqpLib\Connection\AMQPStreamConnection;
    ...
    $channel->exchange_declare(
        parse_ini_file("global-var-config.ini", true)['EXCHANGES']['TRANSFERE_OPERATION_EXCHANGE'],
        'fanout',
        false,
        true,
        false);
    ...
    list($queue_name, ,) = $channel->queue_declare(
        parse_ini_file("global-var-config.ini", true)['QUEUES']['WEB_CLIENT_TRANSFERE_OPERATION_CREATED_QUEUE'],
        false,
        true,
        false,
        false);
    ...
    echo " [*] Waiting for Transfert operation creation \n\n To exit press CTRL+C\n";
    ...
    try {
        ...
        $url = parse_ini_file("global-var-config.ini", true)['URLS']['HOST_WEB_CLIENT'] . '/api/transfert_operation_created';
