...
use PhpAmqpLib\Connection\AMQPStreamConnection;
    ...
    list($queue_name, ,) = $channel->queue_declare(
        parse_ini_file("global-var-config.ini", true)['QUEUES']['WEB_CLIENT_SERVICE_CREATED_QUEUE'],
        false,
        true,
        false,
        false);
    ...
    try {
        ...
        $url = parse_ini_file("global-var-config.ini", true)['URLS']['HOST_WEB_CLIENT'] . '/api/service_with_no_unit_price_assigned';
