...
use PhpAmqpLib\Connection\AMQPStreamConnection;
    ...
    $channel->exchange_declare(
        parse_ini_file("global-var-config.ini", true)['EXCHANGES']['REGISTER_BULK_RECEIPT_EXCHANGE'],
        'fanout',
        false,
        true,
        false);
    ...
    list($queue_name, ,) = $channel->queue_declare(
        parse_ini_file("global-var-config.ini", true)['QUEUES']['WEB_CLIENT_BULK_RECEIPT_REGISTERED_QUEUE'],
        false,
        true,
        false,
        false);
    ...
    echo " [*] Waiting for bulk receipts to be registered\n\n To exit press CTRL+C\n";
    ...
    try {
        ...
        $url = parse_ini_file("global-var-config.ini", true)['URLS']['HOST_WEB_CLIENT'] . '/api/register-bulk-receipt';
