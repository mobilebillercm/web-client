...
use PhpAmqpLib\Connection\AMQPStreamConnection;
    ...
    $channel->exchange_declare(
        parse_ini_file("global-var-config.ini", true)['EXCHANGES']['PAYMENT_WITH_MOBILE_BILLER_ACCOUNT_ACCEPTED_EXCHANGE'],
        'fanout',
        false,
        true,
        false);
    ...
    list($queue_name, ,) = $channel->queue_declare(
        parse_ini_file("global-var-config.ini", true)['QUEUES']['WEB_CLIENT_PAYMENT_WITH_MOBILE_BILLER_ACCOUNT_ACCEPTED_QUEUE'],
        false,
        true,
        false,
        false);
    ...
    echo " [*] Waiting for payement with mobile biller credit account to be made \n\n To exit press CTRL+C\n";
    ...
    try {
        ...
        $url = parse_ini_file("global-var-config.ini", true)['URLS']['HOST_WEB_CLIENT'] . '/api/payement-with-mobile-biller-credit-acount-made';
